...
if db_file is not None and daily_file is not None:
    try:
        ...
        if mixed_mask.any():
            ...
            st.divider()
            if not split_confirmed: st.stop() # 🛑 熔断点
        ...
        if unknown_mats:
            ...
            st.divider()
            if not map_confirmed: st.stop() # 🛑 熔断点
        ...
        if missing_mask.any():
            ...
            st.divider()
            if not price_confirmed: st.stop() # 🛑 熔断点
        ...
        if missing_rules:
            ...
            st.divider()
            if not fee_confirmed: st.stop() # 🛑 熔断点
